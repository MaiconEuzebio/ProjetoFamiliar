...
public class ParamJson {
	...
	private String strErroCompleto;
	...
	public String getStrErroCompleto() {
		return strErroCompleto;
	}

	public void setStrErroCompleto(String strErroCompleto) {
		this.strErroCompleto = strErroCompleto;
	}
