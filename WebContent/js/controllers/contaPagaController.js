app.controller("contaPagaController", function ($scope, $routeParams, requisicaoService, filterFilter, orderByFilter) {
   ...
   //////////////////////////////////////////////////////////////////
	function atualizarTela(){
    	...
    	requisicaoService.requisitarGET("capCar/exibirTodosInativos", function(retorno) {
    		if (!retorno.isValid) {
    	...
    	requisicaoService.requisitarGET("capCar/obterTodosInativos", function(retorno) {
    		if (!retorno.isValid) {
    			$scope.mensagemModal  = retorno.msg;
    			$scope.showModalAviso = true;
    			$scope.mostrarAguarde = false;
